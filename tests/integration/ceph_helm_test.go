...
func (hs *HelmSuite) SetupSuite() {
	...
	mons := 1
	rbdMirrorWorkers := 1
	hs.op, hs.kh = StartTestCluster(hs.T, helmMinimalTestVersion, hs.namespace, "bluestore", true, true, false, "", mons, rbdMirrorWorkers, installer.VersionMaster, installer.NautilusVersion)
