...
func (suite *SmokeSuite) SetupSuite() {
	...
	mons := 3
	rbdMirrorWorkers := 1
	suite.op, suite.k8sh = StartTestCluster(suite.T, smokeSuiteMinimalTestVersion, suite.namespace, "bluestore", false, useDevices, false, "", mons, rbdMirrorWorkers, installer.VersionMaster, installer.NautilusVersion)
