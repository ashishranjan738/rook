...
func (s *CephBlockSuite) SetupSuite() {
	...
	mons := 1
	rbdMirrorWorkers := 1
	s.op, s.kh = StartTestCluster(s.T, blockMinimalTestVersion, s.namespace, "filestore", useHelm, useDevices, false, "", mons, rbdMirrorWorkers, installer.VersionMaster, installer.NautilusVersion)
